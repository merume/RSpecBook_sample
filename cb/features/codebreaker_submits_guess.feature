Feature: code-breaker submits guess
  ...
  The code-breaker submits a guess of four number. The game marks the guess
	with + and - signs.
	...
	that matches the number but not the position of a number in the secret cade,
	a - is added to the mark.

  Each position in the secret code can only be matched onec. For example, a
